...
export const adminRestService = {
  ...
  /** Cập nhật dịch vụ - PUT /api/shared/api/{id} */
  updateService: async (id: string, payload: UpdateServicePayload): Promise<void> => {
    await apiClient.put(`/shared/api/${id}`, payload);
  },

  /** Xóa dịch vụ - DELETE /api/shared/api/{id} */
  deleteService: async (id: string): Promise<void> => {
    await apiClient.delete(`/shared/api/${id}`);
  },

...
import { useGraphqlDemo } from '../../features/common/graphql-demo/model/useGraphqlDemo';
      ...
      {loading && list.length === 0 ? (
        ...
        <View style={styles.errorBox}>
          ...
          <Text style={styles.hint}>
            Kiểm tra: (1) BE chạy cổng 5268 (dotnet run), (2) Sửa 5 IP trong src/shared/config/api.config.ts cho đúng mạng, (3) Expo Go trên máy thật phải dùng IP máy tính (vd 192.168.1.26).
          </Text>
        </View>
      ) : (
        <FlatList
